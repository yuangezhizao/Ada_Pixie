...
#define EXAMPLE_LCD_GPIO_MISO (GPIO_NUM_NC)
#define EXAMPLE_LCD_GPIO_RST  (GPIO_NUM_NC)
#define EXAMPLE_LCD_GPIO_DC   (GPIO_NUM_43)
#define EXAMPLE_LCD_GPIO_CS   (GPIO_NUM_46) // GPIO_NUM_44
#define EXAMPLE_LCD_GPIO_BL   (GPIO_NUM_44) // GPIO_NUM_46

...
#if (defined CONFIG_ESP32_S3_KORVO_V2_BOARD) || (defined CONFIG_ESP32_S3_BOX_3_BOARD) || \
...
#elif (defined CONFIG_ESP32_P4_FUNCTION_EV_V14_BOARD) || (defined CONFIG_ESP32_S3_KORVO_2L_BOARD) || \
    (defined CONFIG_ATOMS3_ECHO_BASE_BOARD) || (defined CONFIG_SPARK_BOT_45COLL)

...
首先需要在[Coze 文档中](https://bytedance.larkoffice.com/docx/Da6qd87pQodvNrxdFYrcnzMxnsh)申请 `Access token` 和 `BOT ID`账号
...
1. 在 managed_components->tempotian\_\_codec_board->board_cfg.txt 重定义自己的开发板相关的 IO pin 和 codec 芯片。
2. 在 managed_components->espressif\_\_gmf_app_utils->Kconfig.projbuild 中加上相关的 board 的配置
